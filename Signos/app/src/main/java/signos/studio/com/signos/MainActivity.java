...
public class MainActivity extends Activity {
    ...
    private String[] perfis = {
        "Arianos são animados, indepentes, individualistas, dinamicos, corajosos e aventureiros",
        "Taurinos são positivos,pacientes, determinados, noturnos, leais e romanticos",
        "Geminianos são positivos, mutaveis, racionais e bastante volateis",
        "...", "...", "...", "...", "...", "...", "...", "...", "...",
